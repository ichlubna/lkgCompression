...
for LINE in $CONTENT; do
    ...
    magick ${TEST_FILES[0]} -gravity North -pointsize 300 -fill blue -annotate +-0+0 '1' $2/0.png
    magick ${TEST_FILES[1]} -gravity North -pointsize 300 -fill blue -annotate +-0+0 '2' $2/1.png
    clear
    ANSWER=""
